...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a2e] flex">
      ...
      <div className="w-1/2 flex items-center justify-center">
        <div className="text-purple-400 text-9xl opacity-50"><img src="/image-register.png" /></div>
      </div>
      ...
      <div className="w-1/2 flex flex-col justify-center px-16">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#1a1a3e] text-white px-4 py-3 rounded-lg border border-gray-700 focus:outline-none focus:border-indigo-500"
            />
          </div>
          ...
          <a href="/password-forgot" className="block text-indigo-400 hover:text-indigo-300 text-sm">
        ...
        <p className="text-gray-400 text-center mt-6">
          Pas de compte ?{' '}
          <a href="/register" className="text-indigo-400 hover:text-indigo-300">S'inscrire</a>
        </p>
      </div>
    </div>
  )
